...
Тесты должны запускаться через make test и проходить. Каждый файл должен быть покрыт как
минимум на 50%. Не покрываются тестами автосгенерированные файлы.
...
1. make test запускает модульные тесты и собирает статистику.
